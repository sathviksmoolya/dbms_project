            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="add_deductions.php" name="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="number" name="healthinsurance" class="form-control" required="required" value="<?php echo $healthinsurance; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Garnishments</label>
                  <div class="col-sm-8">
                    <input type="number" name="garnishments" class="form-control" value="<?php echo $garnishments; ?>" required="required">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Others</label>
                  <div class="col-sm-8">
                    <input type="number" name="others" class="form-control" value="<?php echo $others; ?>" required="required">
                  </div>
                <!-- </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="number" name="loans" class="form-control" value="<?php echo $loans; ?>" required="required">
                  </div>
                </div>
