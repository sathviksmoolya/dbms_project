          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" pattern="[A-Z][A-Za-z\- ]+" name="fname" class="form-control" placeholder="Firstname" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" pattern="[A-Z][A-Za-z\- ]+" name="lname" class="form-control" placeholder="Lastname" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="email" pattern="^[\w.%+-]+@(gmail.com|yahoo.com)$" name="email" class="form-control" placeholder="Email" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" pattern="[6-9][0-9]{9}" minlength="10" name="contact" class="form-control" placeholder="Contact Number" required>
                  </div>
                </div>
